...
public class FakeDataDummy {
    ...
    public static ArrayList<CourseEntity> generateDummyCourses(boolean bookmarked) {
    ...
    public static CourseEntity getCourse(String courseId) {
        for (int i = 0; i < generateDummyCourses(false).size(); i++) {
            CourseEntity entity = generateDummyCourses(false).get(i);
