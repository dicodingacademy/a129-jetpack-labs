...
public class CourseEntity {
    ...
    public CourseEntity(@NonNull String courseId, String title, String description, String deadline, Boolean bookmarked, String imagePath) {
    ...
    public void setCourseId(@NonNull String mCourseId) {
